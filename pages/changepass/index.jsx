      ...
      <div className="main container-fluid py-2 bg-light rounded">
        <div className="row gap-2">
          ...
          <div className="right_home col col-md-9 bg-white rounded text-center">
            ...
            <div className="group_form justify-content-center align-items-center">
              <form>
                <div className="omrs-input-group mt-3">
                  <label className="omrs-input-underlined">
                    <input type="email" name="email" required />
                    <span className="omrs-input-label">Enter your e-mail</span>
                ...
                <div className="omrs-input-group mt-3 ml-5">
                  <label className="omrs-input-underlined">
